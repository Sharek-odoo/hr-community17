...
class HREmployeePortal(http.Controller):
    ...
    def get_letters(self, letter_id, access_token=None, report_type=None, download=False, **kw):
        ...
        if letter_data.service_type == 'salary_introduction':
            report_name = request.env.ref('sharek_hr_letter_request_ksa.salary_introduction_report_action')
        elif letter_data.service_type == 'salary_transfer':
            report_name = request.env.ref('sharek_hr_letter_request_ksa.salary_transfer_template')
        elif letter_data.service_type == 'letter_of_authority':
            report_name = request.env.ref('sharek_hr_letter_request_ksa.letter_of_authority_template')
        else:
            report_name = request.env.ref('sharek_hr_letter_request_ksa.experience_certificate_template')
